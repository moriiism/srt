...
void ArgValRichlucyFpsrcSmthBg::Init(int argc, char* argv[])
{
    progname_ = "richlucy_fpsrc_smth_bg";
...
void ArgValRichlucyFpsrcSmthBg::Print(FILE* fp) const
{
...
void ArgValRichlucyFpsrcSmthBg::Null()
{
    progname_ = "";
    datafile_ = "";
    fixed_src_list_ = "";
...
void ArgValRichlucyFpsrcSmthBg::SetOption(int argc, char* argv[], option* long_options)
{
    if(0 < g_flag_verbose){
        MPrintInfo("start...");
    }
...
void ArgValRichlucyFpsrcSmthBg::Usage(FILE* fp) const
{
    fprintf(fp,
