#ifndef MORIIISM_SRT_RICHLUCY_FPSRC_SMTH_BG_PMPROJ_ARG_RICHLUCY_FPSRC_SMTH_BG_PMPROJ_H_
#define MORIIISM_SRT_RICHLUCY_FPSRC_SMTH_BG_PMPROJ_ARG_RICHLUCY_FPSRC_SMTH_BG_PMPROJ_H_ 

#include "mi_base.h"

class ArgValRichlucyFpsrcSmthBgPmproj : public MiArgBase{
public:
    ArgValRichlucyFpsrcSmthBgPmproj() :
        MiArgBase(),
        progname_(""),
        datafile_(""),
        fixed_src_list_(""),
...
#endif // #ifndef MORIIISM_SRT_RICHLUCY_FPSRC_SMTH_BG_PMPROJ_ARG_RICHLUCY_FPSRC_SMTH_BG_PMPROJ_H_
