...
for index in range(len(out_dir_lst)):
    ...
    cmd = [srt_dir + "/" + "mkresp_det2" + "/" + "mkresp_det2",
           respdir1, respdir2, outdir_mkresp, outfile_head,
    ...
    for index_phase in range(len(phase_id_lst)):
        ...
        bg_file1 = "none"
        bg_file2 = "none"
        resp_norm_file1 = (out_dir_lst[index] + "/" + "resp" +
                           "/" + "rl_resp_norm_det1.fits")
        resp_norm_file2 = (out_dir_lst[index] + "/" + "resp" +
                           "/" + "rl_resp_norm_det2.fits")        
        ...
        cmd = [srt_dir + "/" + "richlucy_det2" + "/" +
               "richlucy_det2_openblas",
