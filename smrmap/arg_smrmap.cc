...
void ArgValSmrmap::Init(int argc, char* argv[])
{
    progname_ = "smrmap";
...
void ArgValSmrmap::Print(FILE* fp) const
{
...
void ArgValSmrmap::SetOption(int argc, char* argv[], option* long_options)
{
    if(0 < g_flag_verbose){
        MPrintInfo("start...");
    }
...
void ArgValSmrmap::Usage(FILE* fp) const
{
    fprintf(fp,
