    ...
    if(isky < nsky){
        ...
        if((0 <= iskyx && iskyx < nskyx - 1) &&
           (0 <= iskyy && iskyy < nskyy - 1)){
            beta += sky_dash_dev_arr[isky]
                + sky_dash_dev_arr[isky_plus_x];
        }
        // term2
        if((1 <= iskyx && iskyx < nskyx) &&
           (0 <= iskyy && iskyy < nskyy - 1)){
            beta += sky_dash_dev_arr[isky_minus_x]
                + sky_dash_dev_arr[isky];
        }
        // term3
        if((0 <= iskyx && iskyx < nskyx - 1) &&
           (0 <= iskyy && iskyy < nskyy - 1)){
            beta += sky_dash_dev_arr[isky]
                + sky_dash_dev_arr[isky_plus_y];
        }
        // term4
        if((0 <= iskyx && iskyx < nskyx - 1) &&
           (1 <= iskyy && iskyy < nskyy)){
        ...
        if((nskyx - 1 == iskyx) &&
           (1 <= iskyy && iskyy < nskyy)){
            beta += sky_dash_dev_arr[isky_minus_y]
                + sky_dash_dev_arr[isky];
        }
        beta *= 2.0;
