#include "arg_richlucy_bg2_smth.h"

// public

void ArgValRichlucyBg2Smth::Init(int argc, char* argv[])
{
    progname_ = "richlucy_bg2_smth";
...
void ArgValRichlucyBg2Smth::Print(FILE* fp) const
{
...
void ArgValRichlucyBg2Smth::Null()
{
    progname_ = "";
    datafile_ = "";
    bgfile_   = "";
...
void ArgValRichlucyBg2Smth::SetOption(int argc, char* argv[], option* long_options)
{
    if(0 < g_flag_verbose){
        MPrintInfo("start...");
    }
...
void ArgValRichlucyBg2Smth::Usage(FILE* fp) const
{
    fprintf(fp,
