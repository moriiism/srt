#ifndef MORIIISM_SRT_RICHLUCY_FPSRC_SMTH_BG_MM_ARG_RICHLUCY_FPSRC_SMTH_BG_MM_H_
#define MORIIISM_SRT_RICHLUCY_FPSRC_SMTH_BG_MM_ARG_RICHLUCY_FPSRC_SMTH_BG_MM_H_

#include "mi_base.h"

class ArgValRichlucyFpsrcSmthBgMM : public MiArgBase{
public:
    ArgValRichlucyFpsrcSmthBgMM() :
        MiArgBase(),
        progname_(""),
        datafile_(""),
        fixed_src_list_(""),
...
#endif // MORIIISM_SRT_RICHLUCY_FPSRC_SMTH_BG_MM_ARG_RICHLUCY_FPSRC_SMTH_BG_MM_H_
