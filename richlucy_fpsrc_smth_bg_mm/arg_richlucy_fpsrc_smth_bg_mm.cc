#include "arg_richlucy_fpsrc_smth_bg_mm.h"

// public

void ArgValRichlucyFpsrcSmthBgMM::Init(int argc, char* argv[])
{
    progname_ = "richlucy_fpsrc_smth_bg_mm";
...
void ArgValRichlucyFpsrcSmthBgMM::Print(FILE* fp) const
{
...
void ArgValRichlucyFpsrcSmthBgMM::Null()
{
    progname_ = "";
    datafile_ = "";
    fixed_src_list_ = "";
...
void ArgValRichlucyFpsrcSmthBgMM::SetOption(int argc, char* argv[], option* long_options)
{
    if(0 < g_flag_verbose){
        MPrintInfo("start...");
    }
...
void ArgValRichlucyFpsrcSmthBgMM::Usage(FILE* fp) const
{
    fprintf(fp,
