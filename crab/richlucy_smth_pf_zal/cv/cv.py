...
hyper_par_list = sys.argv[iarg]; iarg += 1
...
print("nem = ", nem)
print("tol_em = ", tol_em)
print("hyper_par_list = ", hyper_par_list)
...
#mu_lst = [1.0e-3, 1.0e-2, 1.0e-1, 1.0]
#gamma_lst = [1.0e-3, 1.0e-2, 1.0e-1, 1.0]
        ...
        for ifold in range(nfold):
            ...
            for index in range(len(phase_tag_lst)):
                ...
                print(f"{data_file} {phase_tag_lst[index]} "
                      f"{phase_ratio[index]} {flux_0[index]}",
                      file=data_list_fptr)
