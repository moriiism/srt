...
void ArgValRichlucySmthPf::Init(int argc, char* argv[])
{
    progname_ = "richlucy_smth_pf";
...
void ArgValRichlucySmthPf::Print(FILE* fp) const
{
    ...
    fprintf(fp, "%s: nu_0_file_ : %s\n", __func__, nu_0_file_.c_str());
...
void ArgValRichlucySmthPf::Null()
{
    progname_ = "";
    data_list_ = "";
...
void ArgValRichlucySmthPf::SetOption(int argc, char* argv[], option* long_options)
{
    if(0 < g_flag_verbose){
        MPrintInfo("start...");
    }
...
void ArgValRichlucySmthPf::Usage(FILE* fp) const
{
    fprintf(fp,
