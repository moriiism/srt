...
void ArgValDca::Init(int argc, char* argv[])
{
    progname_ = "dca";
...
void ArgValDca::Print(FILE* fp) const
{
...
void ArgValDca::SetOption(int argc, char* argv[], option* long_options)
{
    if(0 < g_flag_verbose){
        MPrintInfo("start...");
    }
...
void ArgValDca::Usage(FILE* fp) const
{
    fprintf(fp,
