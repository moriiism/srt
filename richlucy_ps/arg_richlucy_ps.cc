...
void ArgValRichlucyPs::Init(int argc, char* argv[])
{
    progname_ = "richlucy_ps";
...
void ArgValRichlucyPs::Print(FILE* fp) const
{
...
void ArgValRichlucyPs::SetOption(int argc, char* argv[], option* long_options)
{
    if(0 < g_flag_verbose){
        MPrintInfo("start...");
    }
...
void ArgValRichlucyPs::Usage(FILE* fp) const
{
    fprintf(fp,
            "usage: %s [--help (0)] [--verbose (0)] [--debug (0)] "
            "datafile  resp_norm_file  eff_file  "
