#include "arg_richlucy_bg2_smooth.h"

// public

void ArgValRichlucyBg2Smooth::Init(int argc, char* argv[])
{
    progname_ = "richlucy_bg2_smooth";
...
void ArgValRichlucyBg2Smooth::Print(FILE* fp) const
{
...
void ArgValRichlucyBg2Smooth::Null()
{
    progname_ = "";
    datafile_ = "";
    bgfile_   = "";
...
void ArgValRichlucyBg2Smooth::SetOption(int argc, char* argv[], option* long_options)
{
    if(0 < g_flag_verbose){
        MPrintInfo("start...");
    }
...
void ArgValRichlucyBg2Smooth::Usage(FILE* fp) const
{
    fprintf(fp,
